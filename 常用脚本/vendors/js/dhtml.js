...
function showLoading(){
	...
	$(document.body.firstChild).before('<div id="emvc-ajaxloading-div" style="position:absolute;border:1px solid #eee;background:#fff none repeat scroll 0 0;padding-top:10px;padding-bottom:10px;text-align:center;right:5px;top: 5px; width:120px;z-index:1001;display:none"><img alt="载入状态" src="'+pic+'"/><p id="emvc-ajaxloading-msg" style="color:#FF6600">'+msg+'</p></div>');
