...
if(typeof Eg_ejdmenu == "undefined"){
	var Eg_ejdmenu = {
		Version: '0.0.1',
		inc_js:['jquery.bgiframe.js','jquery.dimensions.js','jquery.jdMenu.js'],
		inc_css:['jdMenu.css'],
		...
		autoload: function() {
			...
			$('script').each(function(){
				var eg_obj = Eg_ejdmenu;
				if(this.src && this.src.match(/ejdmenu\.js(\?.*)?$/)){
					var path = this.src.replace(/ejdmenu\.js(\?.*)?$/,'');
